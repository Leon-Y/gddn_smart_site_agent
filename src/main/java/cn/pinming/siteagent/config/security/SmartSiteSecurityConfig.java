...
import cn.pinming.siteagent.config.security.zzauthentication.filter.ZZAuthenticationConfig;
...
public class SmartSiteSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private BrowserAuthenticationFailureHandler failureHandler;

    @Resource(name = "generalUserDetailService")
    ...
    @Autowired
    private ZZAuthenticationConfig zzAuthenticationConfig;
